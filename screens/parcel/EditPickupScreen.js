...
export default EditPickupScreen = ({ route, navigation }) => {
  ...
  const handleAddSenderScreen = () => {
    try {
      navigation.navigate("EditSenderScreen", {
        id:id,
  ...
  const handleAddSenderAddressScreen = () => {
    try {
      navigation.navigate("EditSenderAddressScreen", {
        id:id,
        sourceCity: sender.sourceCity,
        sourceCountry: sender.sourceCountry,
        sourceStreet: sender.sourceStreet,
  ...
  const handleAddReceiverAddressScreen = () => {
    try {
      navigation.navigate("EditReceiverAddressScreen", {
        id:id,
        sourceCity: sender.sourceCity,
        sourceCountry: sender.sourceCountry,
        sourceStreet: sender.sourceStreet,
  ...
  const handleAddReceiverScreen = () => {
    try {
      navigation.navigate("EditReceiverScreen", {
        id:id,
        sourceCity: sender.sourceCity,
        sourceCountry: sender.sourceCountry,
        sourceStreet: sender.sourceStreet,
  ...
  const handleContinueButtonPress = () => {
    try {
      if (isReceiverDataComplete()) {
        navigation.navigate("EditParcelScreen", {
          id: id,
          sourceCity: sender.sourceCity,
          sourceCountry: sender.sourceCountry,
          sourceStreet: sender.sourceStreet,
